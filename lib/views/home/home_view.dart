...
class _HomeViewState extends State<HomeView> {
  ...
  Widget _buildHomeViewBody(ColorScheme colorScheme, TextTheme textTheme) {
    return SafeArea(
  ...
  Widget _buildTaskListView(ColorScheme colorScheme, TextTheme textTheme) {
  ...
  Widget _buildEmptyStateWidget(TextTheme textTheme) {
    return Column(
      children: [
        LottieBuilder.asset(
          height: 300,
        ...
        Text(AppStr.homeViewEmpty, style: textTheme.headlineMedium),
      ],
    );
  }
